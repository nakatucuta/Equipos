...
<a href="{{route('perifericos.create')}}" title="DETALLE" class="btn  btn-primary btn-sm">
    ...
    right: 0;"><i class="fas fa-book"></i>  </a> --}}
       <br><br>
<table class="table table-hover table-striped table-bordered  {{-- table-responsive--}}" style="border: 1px solid #000000;" id="persona">
     <thead class="table table-hover table-info table-bordered " style="background-color: #d9f2e6 ;border: 1px solid #000000;">
        <tr>
            ...
            <tbody id="table">
                ...
                @foreach($periferico as $items)
                 <tr>
                    <td>{{$items->id}}</td>
                    <td>{{$items->nombre_periferico}}</td>
